...
if __name__ == "__main__":
    ...
    # ========================= LOAD TUNED RESULTS ========================= #
    save_path     = 'reports/nbeats_inference_results.xlsx'
    tuned_path    = 'reports/nbeats_tuned_params_optimized.xlsx'
    ...
    if save_path and os.path.exists(save_path):
        ...
        columns = [
            ...
            'input_chunk_length', 'output_chunk_length', 'n_epochs', 'batch_size', 'num_stacks', 
            'num_blocks', 'num_layers', 'layer_widths', 'dropout', 'lr', 'random_state', 'validation_split',
    ...
    for dataset_type in dataset_types:
        ...
        print('#######################################################')
        if dataset_type == 'default_noOzon':
            print("⏭️ Skipping dataset_type: default_noOzon")
            continue
        ...
        for _, row in top_models.iterrows():
            ...
            layer_widths        = int(row['layer_widths'])
            ...
            # Get X col list
            X_list = list(X_train_scaled.components)
            ...
            past_for_pred   = X_train_full.append(X_test_scaled)
            ...
            # ========================= SAVE TO EXCEL ========================= #
            nbeats_inference_store_to_excel(
